...
-- Make sure to setup `mapleader` and `maplocalleader` before -- 确保在加载 lazy.nvim 之前设置 Leader 键
-- loading lazy.nvim so that mappings are correct. -- 这样可以确保映射键位正确
-- This is also a good place to setup other settings (vim.opt) -- 这也是设置其他选项的好地方
